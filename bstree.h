...
*/
typedef int (*P_tree_ele_print)(FILE *, const void*);


/**
* P_tree_ele_cmp type definition: pointer to a function that compares two elements of a Tree.
* It returns an integer less than, equal to, or greater than zero if s1 is found,
* respectively, to be less than, to match, or be greater than s2.
*/
typedef int (*P_tree_ele_cmp)(const void*, const void*);
...
* @param cmp_ele Pointer to a function that compare two Tree elements
*
...
/**
* @brief Public function that returns the Tree's size
*
* @param tree Pointer to the Tree.
*
...
* function print_ele is well constructed, this means that, upon successful return,
...
* minimum element. So this operation is logarithm with the length of the path
...
*
* Note that it is necessary to descend the subtree to obtain the
* maximum element. So this operation is logarithm with the length of the path
* from the leaf to the root.
*
* @param tree Pointer to the Tree.
*
...
*
* Note that it is necessary to descend the subtree to obtain the
* remove position. So this operation is logarithm with the length of the path
* from the leaf to the root.
*
* @param tree Pointer to the Tree.
